...
<script type="text/javascript" src="resources/script/zvanje.js"></script>
...
<div style="width: 50%">
	<table id="tbZvanje">
			...
			<tbody>		
				...
				<%List<Zvanje> listZvanje=(List<Zvanje>)request.getAttribute("listaZvanje"); %>				
				<%for(int i=0;i<listZvanje.size();i++){
						%>
					<tr>
					<td><%= listZvanje.get(i).getID_zvanja() %></td>
					<td><%= listZvanje.get(i).getNaziv_zvanja() %></td>
       ...
       <div id="divZvanjePOPUP" style="width:1000px; display: none" >
        <form  id="frmZvanje"  >
        	<table>
        		<tbody>
        			<tr>
        				<td>Zvanje:</td>
        				<td><input type="text" id="zvanje" name="zvanje"></td>
        			</tr>
